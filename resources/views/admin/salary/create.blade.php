...
@section('content')
  <div class="container">
    	...
    	<div id="formGrid" class="mb-5">
									<h4>Salary Payment Create <span> <a href="{{ route('admin.salaries.index') }}" class="btn btn-primary">Back To Salary Payment Dashboard</a></span></h4>
									<p></p>
									<div class="card">
										<div class="card-body">
            ...
            <div class="mb-3">
															...
															<div class="input-group">
																<input type="text" name="payment_date" class="form-control" id="datepicker-component" placeholder="with input group addon">
