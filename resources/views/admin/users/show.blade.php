...
@section('content')
  <div class="container">
						...
						<div class="row">
							...
							<div class="col-xl-9">
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">User Detail Dashboard</li>
								</ul>
								
								<h1 class="page-header">
									User Detail Dashboard <small>page header description goes here...</small>
								</h1>
								...
								<div id="datatable" class="mb-5">
									<h4><a href="{{ route('admin.roles.index') }}" class="btn btn-primary">Back To Users Dashboard</a></h4>
									<p></p>
									<div class="card">
										<div class="card-body">
       ...
       <tr>
        ...
        <tr>
          <th>Created At</th>
           <td>{{ $user_detail->created_at->format('F j, Y') }}</td>

        </tr>
        <tr>
          <th>Updated At</th>
           <td>{{ $user_detail->updated_at->format('F j, Y') }}</td>
